...
var element = document.querySelector(".phone__input"),
  maskOptions = { mask: "+{3}(000)000-00-00" },
  mask = IMask(element, maskOptions);

function accordion() {
  document.querySelectorAll(".accordion__item-trigger").forEach(function (e) {
    e.addEventListener("click", function () {
      var t = e.parentNode;
      t.classList.contains("accordion__item-active")
        ? t.classList.remove("accordion__item-active")
        : (document.querySelectorAll(".accordion__item").forEach(function (e) {
            return e.classList.remove("accordion__item-active");
          }),
          t.classList.add("accordion__item-active"));
    });
  });
}

function tabs(e, t, c, i) {
  var n =
      arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "flex",
  ...
  function d() {
    ...
    (s[e].style.display = n), o[e].classList.add(i);
  }
  ...
  r(),
    ...
    a.addEventListener("click", function (e) {
      var c = e.target;
      (c.classList.contains(t.replace(/\./, "")) ||
        c.parentNode.classList.contains(t.replace(/\./, ""))) &&
        o.forEach(function (e, t) {
          (c != e && c.parentNode != e) || (r(), d(t));
        });
    });
}
